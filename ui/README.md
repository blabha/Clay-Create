...
Clay Create is a broader human-in-the-loop fabrication system where participants shape clay blocks guided by projected contours generated from AI target geometry. This interface handles the session logic: who sculpts which block, in what order, and when.
